%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Program 13 Supplement: Matlab function file to plot the
%% u versus (x,y) data from program13.cpp
%%
%% Inputs:
%% N, M              Grid parameters for solution
%% program13.out     Data file from program13.cpp; first
%%                   few lines of text must be removed
%%                   from file before using.
%%
%% Outputs:
%% prog13_Cmap.pdf   PDF file of contour map of u(x,y)
%%
%%
%% Here's how to get started:
%%
%%  1) Copy matlab13.m (this file) into your working directory.
%%
...
%%     few lines of text from program13.out.
%%
%%  4) To run this program, type "matlab13" at the prompt in 
%%     the MATLAB window.
%%
%%  5) After the program runs, the results will be displayed
%%     on the screen and saved in the file "prog13_Cmap.pdf" 
%%     in your working directory.
%%
%%  6) To re-run the program, just type "matlab13" at the
...
xyuData = importdata('program13.out') ;
for i=1:N+2
